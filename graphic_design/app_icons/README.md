...
Given that an app's icon is the first thing seen by a new user, there is tremendous psychological and experiential weight placed on the role of the icon. Icons not only demonstrate to users how the given app will "treat them", but also displays the _mindset_ that the user should be in when interacting with the app. For instance, the icons for meditation apps prepare us for a duration of calmness, and the icons for fitness apps prepare us for a duration of activity.
