...
Next, we adjust our aesthetics and layout. Additional conveniences include...
- a horizontal line at y=0 to separate gains from losses
- a legend that runs off of a list comprehension to make sure any number of tickers can be represented
- forcing the x and y axes to use a `MultipleLocator` of 0.01 to keep our thinking in percentage terms
